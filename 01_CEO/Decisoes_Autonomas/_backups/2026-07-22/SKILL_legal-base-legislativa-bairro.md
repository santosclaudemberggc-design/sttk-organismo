...
- **Onde decreto e lei conflitarem, a lei vence.** Antes de aceitar uma exigência ou uma recusa que só aparece em decreto, **cheque se a lei diz o contrário**. Exemplo vivo: o Decreto 55.622/2025 (Anexo I, Condições Gerais, 1) diz que "não serão aceitas plantas baixas dos pavimentos, fachadas..."; se o COES (LC 198/2019) ou a LUOS (LC 270/2024) exigirem essas peças, a recusa do decreto não se sustenta. **Pendência aberta em 21/07/2026 — não resolvida.**
...
| Outorga onerosa (CAB→CAM) | `POP-LEGAL-02` — ⚠️ **use com reserva**: ele cita LC 281/2025 arts. 18/19, lei que **não está arquivada** em `Fontes_Legislacao/`; no primário que temos (LC 274/2024) a matéria está nos arts. 21/22. Baixe a LC 281/2025 por fonte oficial antes de orientar cliente real |
...
- **Não existe direito adquirido de afastamento** — nem no COES, nem na LC 270/2024 (verificado em busca no texto integral). O que existe é caminho **oneroso** de legalização por contrapartida do que já foi executado. ⚠️ **FUNDAMENTO CAIU (verificado 21/07/2026):** a base citava **LC 274/2024 Art. 38**, **revogado** pela **LC 281/2025, Art. 42, II** — que derrubou os arts. 5º-14, 17-23, 26 e 38 daquela lei. A conclusão pode seguir válida, mas **o artigo que a sustentava não existe mais**. Reconstrua o fundamento na norma vigente antes de citar em qualquer peça: **citar artigo revogado em protocolo é vício grave**.
- **Obra nova não herda tolerância do preexistente.** Responde pela regra ordinária por conta própria.
- **Contrapartida compra área, não compra habitabilidade** — leitura que segue correta, mas ⚠️ **o fundamento caiu junto**: era LC 274/2024 Art. 12 §2º, dentro do bloco revogado pela LC 281/2025 Art. 42, II. Reconstrua antes de usar.
...
3. Cheque restrições sobrepostas: AEI, AEIS, Áreas Protegidas, APAC, APP.
...
Em `01_CEO/Gestores/Kelsen (Legal)/Agentes/Hely/Fontes_Legislacao/`, com índice comentado (data de download e proveniência) em `_indice_fontes.md` — **que tem erro conhecido na seção COES e está pendente de correção; prefira o PDF primário**:

- `COES_LeiComplementar198_2019.pdf` — Código de Obras e Edificações Simplificado
- `LC270_2024_PlanoDiretorLUOS.pdf` — Plano Diretor / LUOS (384 p.)
- `LC274_2024.pdf` — instrumentos da LC 270/2024
...
POPs em `.../Agentes/Hely/POPs/`: `POP-LEGAL-RIU-01`, `POP-LEGAL-02`, `POP-LEGAL-03`, `POP-LEGAL-04`.

**Lacunas conhecidas:** Decreto 45.917/2019 (regulamento do COES) não lido — agregadores devolvem HTTP 403, falta via oficial. LC 291/2025 (altera o COES) confirmada só por fonte secundária.
