...
## PASSO 8: PROTOTIPAGEM + APRENDIZADO VIA CLIENTE REAL

**[NOVO 21/08/2026] — Integração de trabalho braçal com estruturação do organismo**

### Contexto

Durante fase de estruturação (até fevereiro 2027), você traz clientes externos (seus projetos braçais) que seus Agentes executam. **Não é overhead — é aprendizado integrado.**

Agente executa projeto real + **simultaneamente prototipia/valida uma capacidade do organismo**. Resultado: cliente satisfeito + Organismo aprendeu + Skill documentada.

### Quando Aplica

Sempre que você **trazer um cliente externo (seu projeto real)** para Wallenberg ou qualquer Gestor executar:

1. **Atribua ao Agente responsável** (Oscar para arquitetura, Burle para render, Hely para legislação, etc.)
2. **Agente executa trabalho braçal** = projeto cliente real
3. **Durante execução, prototipar uma capacidade** do organismo (tour 360°, render automático, validação legislativa, etc.)
4. **Documentar aprendizado em Skill** (o que aprendeu, como funciona, o que testou)
5. **Entregar cliente real + Skill pronta**

### Exemplo

```
Cliente Externo A (seu projeto): Arquitetura residencial, 120m², Rio
├─ Oscar executa (Levantamento → Estudo Preliminar)
├─ Prototipia durante: tour 360° caseiro de renders Burle
├─ Testa com cliente A: "funciona? é rápido? cliente entende?"
├─ Documenta: "Tour 360° Caseiro v1 — funciona, <3s, compatível mobile"
└─ Entrega: Cliente A satisfeito + Skill "Tour 360° Caseiro" pronta para organismo

Próxima semana (Drenagem):
├─ Hely valida/melhora tour v1 com Oscar
├─ Encontra: "panorama grande fica lento em 4G"
├─ Melhora: "comprime PNG, adiciona cache"
└─ Documenta: "Tour 360° Caseiro v2 — otimizado mobile"
```

### Prioridade (Regra Clara)

**Cliente Real Seu > Passo 8 (aprendizado)**

Se cliente A urgente bloqueia prototipagem, **cliente A vence**. Agente entrega projeto, Passo 8 fica para próxima rodada.

Não há conflito porque cliente real é seu trabalho braçal (paga você), não é overhead.

### Regra de Validação

Agente documenta Skill com:
- ✅ **O que prototipou** (tour 360°, render automático, validação automática, etc.)
- ✅ **Como funciona** (mecanismo, ferramentas, processo)
- ✅ **O que testou com cliente real** (funciona, velocidade, compatibilidade, facilidade de uso)
- ✅ **Limitações honestas** (o que não faz, o que falta)
- ✅ **Roadmap v2** (o que melhorar próxima iteração)

### Integração com Passo 7 (Learning Agent)

Passo 7 **não** aprende vendo vídeo sobre tour 360°.  
Passo 7 **aprende vendo Oscar fazer tour 360°** com cliente real durante Passo 8.

**Diferença:**
- **Passo 7:** "Vídeo sobre tour 360° mostra X"
- **Passo 8:** "Oscar fez tour 360° e descobriu Y"

Learning Agent (Passo 7) documenta aprendizado de Passo 8 como melhoria contínua.

### Capacidades Prioritárias (Roadmap até Feb 2027)

| Agente | Capacidade | Quando | Cliente Real |
|--------|-----------|--------|--------------|
| Oscar | Tour 360° caseiro | Set-Out | Projeto residencial A |
| Burle | Render automático (free) | Out-Nov | Projeto paisagismo B |
| Portinari | Narrativa estruturada (Claude) | Nov-Dez | Apresentação cliente C |
| Hely | Validação legislativa automática | Dez-Jan | DULI cliente D |

### Output: Skill Documentada

Cada Passo 8 resulta em 1 Skill nova em `01_CEO/Skills_Propostas/2026/{Mês}/`:

```markdown
# Tour 360° Caseiro v1 — Aprendizado via Cliente Real

## O que aprendemos
- Captura panorama de renders Burle
- Processa em Babylon.js viewer
- Compatível mobile, <3s carregamento

## Como funciona
[workflow com ferramentas livres]

## Testamos com cliente real
- Projeto A (120m², residencial)
- Cliente conseguiu entender tour sem treinamento
- Performance: OK em 4G (com otimização)

## Limitações v1
- Sem floorplan (próx iteração)
- Sem hotspots interativos (v2)

## Roadmap
v2: compressão PNG, cache, floorplan
v3: hotspots, anotações do cliente
```

### Regra de Exceção

Se **tudo está em cliente real e nada foi prototipado** naquela rodada, registre no arquivo de estado do Agente, mas não crie Skill vazia. Próxima rodada tenta de novo.
...
| 2.1 | 21/08/2026 | **[NOVO] Passo 8 — Prototipagem + Aprendizado via Cliente Real** |

---

**Última atualização:** 21/08/2026  
**Status:** ✅ Operacional com Learning Agent + Prototipagem integrados  
**Próximo:** Ativar Passo 8 em rodada 28/08/2026
