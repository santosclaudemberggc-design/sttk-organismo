...
- **Status:** Aguardando ratificação (sobe para a próxima Reunião Semanal). `b14-lacuna-substantiva-transferencia-evtl` fica pendente de ciência direta de Claudemberg — não é item de rotina, é achado de mérito sobre caso real com terceiro na mesa.
